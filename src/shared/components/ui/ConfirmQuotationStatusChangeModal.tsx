  ...
  return (
    ...
    >
      <button
        ...
        onClick={onCancel}
        className="absolute inset-0 bg-secondary/50 backdrop-blur-sm disabled:cursor-not-allowed"
      />
      ...
      >
        ...
        <div className="mt-5 rounded-xl bg-muted px-4 py-5">
        ...
        <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          <button
            ...
            disabled={isConfirming}
            onClick={onCancel}
            className="rounded-xl border border-border bg-card px-5 py-2.5 text-sm font-semibold text-foreground transition hover:bg-muted disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={isConfirming}
            onClick={onConfirm}
            className="rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {isConfirming
