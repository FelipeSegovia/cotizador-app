...
/** Empresa demo compartida por dueño + colaboradores. */
export const DEMO_COMPANY_ID = "company-demo-1";
...
export const mockUsers: MockUser[] = [
  ...
  // Business sin empresa configurada (companyId null) para probar el modal.
  {
    id: "6",
